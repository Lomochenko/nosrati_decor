    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog', models.ManyToManyField(blank=True, related_name='blags_detail', to='Blog.article', verbose_name='مقاله های مرتبط')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='parentcategory', to='Product.category', verbose_name='دسته بندی والد')),
            ],
            options={
